...
const Navbar = () => {
  ...
  return (
    <div className="contenedor">
      ...
      {/* Carrito */}
      <div
        className={`carrito-contenedorGeneral ${
          EstadoOpenCarrito ? 'open' : ''
        }`}
      >
                ...
                <tr key={p.id}>
                  <td className="conteiner-imagen">
                    <img
                      ...
                      alt={p.nombre}
                      width={100}
                      className="carrito-table-body-img"
                    />
                  </td>
        ...
        <div className="carrito-total-subtotal-finalizar">
